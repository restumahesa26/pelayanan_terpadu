			...
			<div class="row justify-content-center" style="margin-top: 120px;">
				<div class="col-10">
					<a href="{{ route('sikomo-dua') }}">
                        <img src="{{ url('frontend/btn-sub-pengaduan-1.png') }}" alt="" width="400" style="margin-top: 5px">
                    </a><br>
                    <a href="{{ $link1 != '' ? $link2->link : '#' }}" target="_blank">
                        <img src="{{ url('frontend/btn-sub-pengaduan-2.png') }}" alt="" width="400" style="margin-top: 5px">
                    </a><br>
                    <a href="{{ $link2 != '' ? $link2->link : '#' }}" target="_blank">
                        <img src="{{ url('frontend/btn-sub-pengaduan-3.png') }}" alt="" width="400" style="margin-top: 5px">
                    </a><br>
                    <a href="{{ $link3 != '' ? $link3->link : '#' }}" target="_blank">
                        <img src="{{ url('frontend/btn-sub-pengaduan-4.png') }}" alt="" width="400" style="margin-top: 5px">
                    </a><br>
				</div>
				<div class="col-2">
