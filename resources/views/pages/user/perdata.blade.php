					...
					<div class="row">
						<div class="col-md-8">
							<a href="{{ $link1 != '' ? $link1->link : '#' }}" target="_blank">
								<img src="{{ url('frontend/btn-perdata-1.png') }}" width="400" style="margin-top: 5px">
							</a><br>
							<a href="{{ $link2 != '' ? $link2->link : '#' }}" target="_blank">
								<img src="{{ url('frontend/btn-perdata-2.png') }}" width="400" style="margin-top: 5px">
							</a><br>
                            <a href="{{ $link3 != '' ? $link3->link : '#' }}" target="_blank">
								<img src="{{ url('frontend/btn-perdata-3.png') }}" width="400" style="margin-top: 5px">
							</a><br>
                            <a href="{{ $link4 != '' ? $link4->link : '#' }}" target="_blank">
								<img src="{{ url('frontend/btn-perdata-4.png') }}" width="400" style="margin-top: 5px">
							</a><br>
                            <a href="{{ $link5 != '' ? $link5->link : '#' }}" target="_blank">
								<img src="{{ url('frontend/btn-perdata-5.png') }}" width="400" style="margin-top: 5px">
							</a><br>
                            <a href="{{ $link6 != '' ? $link6->link : '#' }}" target="_blank">
								<img src="{{ url('frontend/btn-perdata-6.png') }}" width="400" style="margin-top: 5px">
							</a><br>
						</div>
						<div class="col-md-4">
							<img src="{{ url('frontend/perdata.gif') }}" alt="" class="d-none d-md-block" width="450" style="position: absolute; right: 250px; bottom: 0;">
						</div>
					</div>
				</div>
				<div class="col-2">
