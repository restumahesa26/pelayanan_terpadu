					...
					<div class="row">
						<div class="col-md-8">
							<a href="{{ route('pidana.cek-tilang') }}">
								<img src="{{ url('frontend/btn-pidana-1.png') }}" alt="" width="400" style="margin-top: 5px">
							</a><br>
							<a href="{{ $link2 != '' ? $link2->link : '#' }}" target="_blank">
								<img src="{{ url('frontend/btn-pidana-2.png') }}" alt="" width="400" style="margin-top: 5px">
							</a><br>
							<a href="{{ $link3 != '' ? $link3->link : '#' }}" target="_blank">
								<img src="{{ url('frontend/btn-pidana-3.png') }}" alt="" width="400" style="margin-top: 5px">
							</a><br>
							<a href="{{ $link4 != '' ? $link4->link : '#' }}" target="_blank">
								<img src="{{ url('frontend/btn-pidana-4.png') }}" alt="" width="400" style="margin-top: 5px">
							</a><br>
							<a href="{{ $link5 != '' ? $link5->link : '#' }}" target="_blank">
								<img src="{{ url('frontend/btn-pidana-5.png') }}" alt="" width="400" style="margin-top: 5px">
							</a><br>
                            <a href="{{ $link5 != '' ? $link5->link : '#' }}" target="_blank">
								<img src="{{ url('frontend/btn-pidana-6.png') }}" alt="" width="400" style="margin-top: 5px">
							</a><br>
						</div>
						<div class="col-md-4">
							<img src="{{ url('frontend/pidana.gif') }}" alt="" class="d-none d-md-block" width="500" style="position: absolute; right: 250px; bottom: 0;">
						</div>
					</div>
				</div>
				<div class="col-2">
