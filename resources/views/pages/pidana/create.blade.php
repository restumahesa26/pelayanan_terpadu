                    ...
                    <form action="{{ route('pidana.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis" id="jenis" class="form-control @error('jenis') is-invalid @enderror">
                                ...
                                <option value="Izin Penggeledahan & Penyitaan" @if(old('jenis') == 'Izin Penggeledahan & Penyitaan') selected @endif>Izin Penggeledahan & Penyitaan</option>
                                <option value="Pelimpahan Berkas" @if(old('jenis') == 'Pelimpahan Berkas') selected @endif>Pelimpahan Berkas</option>
                                <option value="Perpanjangan Penahanan" @if(old('jenis') == 'Perpanjangan Penahanan') selected @endif>Perpanjangan Penahanan</option>
                                <option value="Izin Besuk Tahanan & Pinjam Pakai Barang Bukti" @if(old('jenis') == 'Izin Besuk Tahanan & Pinjam Pakai Barang Bukti') selected @endif>Izin Besuk Tahanan & Pinjam Pakai Barang Bukti</option>
                            </select>
                            @error('jenis')
